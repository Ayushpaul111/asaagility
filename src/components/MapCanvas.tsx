...
const MapCanvas: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const sparkles: { x: number; y: number; opacity: number; phase: 'fadeIn' | 'fadeOut' }[] = [];
    ...
    return <canvas ref={canvasRef} className="absolute inset-0 w-full h-full" style={{
        maskImage: 'url("https://cdn.prod.website-files.com/66797c2909f9ec0b1ff1a767/667a968d565f94f79f5d8429_us-map.png")',
        maskSize: 'contain',
        maskRepeat: 'no-repeat',
        maskPosition: 'center',
        WebkitMaskImage: 'url("https://cdn.prod.website-files.com/66797c2909f9ec0b1ff1a767/667a968d565f94f79f5d8429_us-map.png")',
