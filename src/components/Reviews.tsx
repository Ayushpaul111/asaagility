...
const testimonials = [
  {
    id: 1,
    text: "Electric E-Rickshaw manufacturers and a renowned seller of popular brand batteries.",
    author: "Suvajit Nag",
    role: "Local Guide · 205 reviews · 268 photos",
    avatar: "",
    rating: 5.0,
    rotation: -10,
    zIndex: 30,
  ...
  {
    id: 2,
    text: "Nice mechanic store for vehicles. Pollution control also done here.",
    author: "Kinjal Datta",
    role: "Local Guide · 52 reviews · 5 photos",
    avatar: "",
    rating: 5.0,
    rotation: -6,
    zIndex: 20,
  ...
  {
    id: 3,
    text: "Reliable battery and good customer support. The staff is helpful and pricing feels fair for the work done.",
    author: "Rahul Sharma",
    role: "Customer",
    avatar: "",
    rating: 5.0,
